...
function harness(t, { override, meta: overrides = {}, childData, initialDates = ["2026-10-09", "2026-10-11"], sharedActions = true, savedChild, cloneResponses = true } = {}) {
  ...
  const label = make("span"), document = Object.assign(bus(), { getElementById: get, createElement: make, hidden: false,
  ...
  const context = { document, window, OwnerAvailability: { ...A,
    ...
    FamilyDates: { ...D, createStore: () => D.createStore(() => storage) }, fetch,
    Date: class extends Date { static now() { return clock; } }, AbortController, AbortSignal, TextEncoder, TextDecoder, Uint8Array,
  ...
  for (const file of ["../../owner/availability-ui.js", "../../owner/child-calendar-ui.js"]) {
    ...
    if (file.endsWith("/child-calendar-ui.js")) {
